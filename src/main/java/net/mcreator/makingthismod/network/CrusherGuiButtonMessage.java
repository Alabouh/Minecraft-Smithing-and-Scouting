...
import net.mcreator.makingthismod.procedures.CrusherCrushProcedure;
...
public class CrusherGuiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			CrusherCrushProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		MakingThisModMod.addNetworkMessage(CrusherGuiButtonMessage.class, CrusherGuiButtonMessage::buffer, CrusherGuiButtonMessage::new, CrusherGuiButtonMessage::handler);
	}
}
