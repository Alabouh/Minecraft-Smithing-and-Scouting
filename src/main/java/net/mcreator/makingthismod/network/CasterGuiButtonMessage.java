...
public class CasterGuiButtonMessage {
	...
	public CasterGuiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(CasterGuiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(CasterGuiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
